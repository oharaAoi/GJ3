...
void PlayerLeftMoveCommand::Execute(){
	host_->SetIndex(preIndex_ + MOVE_VECTOR_LEFT);
...
void PlayerRightMoveCommand::Execute(){
	host_->SetIndex(preIndex_ + MOVE_VECTOR_RIGHT);
...
void PlayerUpMoveCommand::Execute(){
	host_->SetIndex(preIndex_ + MOVE_VECTOR_UP);
...
void PlayerDownMoveCommand::Execute(){
	host_->SetIndex(preIndex_ + MOVE_VECTOR_DOWN);
